...
import { IonInput, IonContent, IonHeader, IonTitle, IonToolbar, ToastController, IonButton, IonCard, IonCardHeader, IonCardTitle, IonNote } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonInput, IonContent, CommonModule, FormsModule, IonButton, IonCard, IonCardHeader, IonCardTitle, IonNote]
})
